...
class BackpackGPT2Model(BackpackGPT2PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.sense_network = BackpackSenseNetwork(config, self.num_senses, self.gpt2_model.embeddings.word_embeddings)
        self.word_embeddings = self.gpt2_model.embeddings.word_embeddings
        self.position_embeddings = self.gpt2_model.embeddings.position_embeddings
